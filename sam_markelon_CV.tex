...
Quantitative Finance, Cryptography, Data Structures, Probability in Computing, and Randomized Algorithms. % Add proof interests here! 
...
\begin{longtable}{L!{\VRule}R}
  2020--2025\quad&{\bf PhD in Computer Science, University of Florida}\\
           ...
           &\quad Thesis: \textit{Data Structures in Adversarial Environments}\\
...
\item \textbf{Mathematics:} Probability Theory, Applied Statistics, Category Theory
\end{itemize}
